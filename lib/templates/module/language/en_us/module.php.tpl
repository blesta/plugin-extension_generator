...
$lang['{{class_name}}.package_field.tooltip.{{package_fields.name}}'] = '{{package_fields.tooltip}}';{{endif:package_fields.tooltip}}{{array:package_fields}}{{if:tlds}}{{if:module_type:registrar}}
$lang['{{class_name}}.package_fields.tld_options'] = 'TLDs';{{endif:module_type}}{{endif:tlds}}
