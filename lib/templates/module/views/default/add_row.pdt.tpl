        ...
        $this->Widget->create($this->_('{{class_name}}.add_row.box_title', true));
        ?>
        <div class="inner">
            <?php
            $this->Form->create();
...
////?><!--
////            <div class="title_row">
////                <h3><?php $this->_('{{class_name}}.add_row.name_servers_title'); ?></h3>
////            </div>
////            <div class="pad">
////                <div class="links_row">
...
////                            <td><?php $this->Form->label($this->_('{{class_name}}.add_row.name_server_col', true)); ?></td>
////                            <td><?php $this->Form->label($this->_('{{class_name}}.add_row.name_server_host_col', true)); ?></td>
////                            <td class="last"></td>
////                        </tr>
////                    </thead>
////                    <tbody>
...
////                            ?>">
////                            <td><?php
////                                $this->_('{{class_name}}.add_row.name_server', false, '<span>' . ($i + 1) . '</span>'); ?>
////                            </td>
////                            <td><?php
...
////                                    $this->_('{{class_name}}.add_row.remove_name_server'); ?>
////                                </a>
////                            </td>
////                        </tr>
////                        <?php
...
////?><!--
////            <div class="title_row">
////                <h3><?php $this->_('{{class_name}}.add_row.notes_title'); ?></h3>
////            </div>
////            <div class="pad">
////                <ul>
////                    <li>
...
////-->
            ...
            <div class="button_row">
                <?php
                $this->Form->fieldSubmit('save', $this->_('{{class_name}}.add_row.add_btn', true), ['class' => 'btn btn-primary pull-right']);
                ?>
            </div>
            <?php
            $this->Form->end();
